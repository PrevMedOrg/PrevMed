...
def scoring(
    ...
    _preamble = (
        ...
        "fragilités dans son patrimoine génétique ([comprendre la génétique](https://preventionfamiliale.fr/Comprendre-la-Genetique.pdf)). Si votre "
    ...
    _lifestyle = (
        ...
        "[alimentation trop riche](https://preventionfamiliale.fr/Prevention-nutritionnelle.pdf) "
        ...
        "[manque d'activité physique](https://preventionfamiliale.fr/Eval-Activite-Physique.pdf) "
    ...
    if 50 <= current_age <= 75 and personal_crc_count == 0 and fdr_crc_count == 0:
        ...
        markdown += (
            ...
            "que l'hypothèse avec la probabilité la plus élevée ([illustration](https://preventionfamiliale.fr/Illustration-1.pdf)). Avec les moyens actuels limités, peu "
            ...
            "cliquant ici](https://preventionfamiliale.fr/Tableau-Preconsultation-Oncogenetique.pdf), soigneusement rempli pour décrire vos antécédents et adressez "
        ...
        markdown += (
            ...
            "refaites le questionnaire pour chaque hypothèse de grand-parent transmetteur "
            "(en omettant les cas de cancer non-apparentés à ce grand-parent) et ne retenez "
            "que l'hypothèse avec la probabilité la plus élevée ([illustration](https://preventionfamiliale.fr/Illustration-2.pdf)). Avec les moyens actuels limités, peu "
